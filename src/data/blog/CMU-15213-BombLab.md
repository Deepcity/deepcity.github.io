...
description: "CMU 15-213 课程 Bomb Lab 实验笔记，通过反汇编与 GDB 调试破解六个关卡。"
slug: "cmu-15213-bomblab"
draft: false
tags:
  - "CMU15213"
  - "c"
...
>
> 为什么不是 sscanf？因为：
> 编译器为了兼容 C99 标准，使用 \_\_isoc99_sscanf作为内部符号它是标准库函数 int sscanf(const char *str, const char *format, ...); 的实现
...
**_Congratulations! You've defused the bomb!_**
