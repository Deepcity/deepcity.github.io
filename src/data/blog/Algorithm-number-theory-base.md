---
title: "算法数论基础"
pubDatetime: 2024-08-24T16:38:26Z
description: "算法竞赛中常用的数论基础知识总结，包括快速幂、GCD、素数筛、欧拉函数等核心算法。"
slug: "algorithm-number-theory-base"
draft: false
tags:
  - "数论"
  - "算法"
...
`cstdlib` 中的 rand（）和 srand（）函数是 C 语言使用的随机数生成方法，通过 **_线性同余法_** 计算。
...
8888..8(x 个 8) => 8 _ 1111..1 => 8 _ 9999..9/9 => 8 \* (10^x-1)/9
...
D(n) = n! - n!/1! + n!/2! - n!/3! + … + (-1)^n _n!/n! = ∑(k = 2~n) (-1)^k _ n! / k!,
