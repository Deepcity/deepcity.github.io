...
### 群体人工智能 `[1 / ?]` / PGStudy 系列 `[2 / ?]`

研究笔记系列（PG-Study），包含群体人工智能与进化计算两个子方向。

| 序号 | 主题 | 状态 | 文件 | slug |
|------|------|------|------|------|
| Part 1 | PSO — 粒子群优化算法（群体人工智能） | ✅ 已发布 | `PGStudy-Swarm-intelligence.md` | `pgStudy-swarm-intelligence` |
| — | EA 与 GA — 进化算法与遗传算法 | ✅ 已发布 | `PGStudy-EAandGA.md` | `pgstudy-eaandga` |
| ? | 待定（推测：蚁群算法 ACO / 人工蜂群 ABC 等） | ❓ 未发布 | — | — |
...
| API Agent: Embedding, MCP, Skills | `API-Agent-Embedding-MCP-Skills.md` | 可发展为 Agent / API 实践系列，目前为首篇 |
...
| `进化算法` | 进化算法（EA）通用标签 | evolutionary algorithm、EA、进化计算 |
| `遗传算法` | 遗传算法（GA）标签 | genetic algorithm、GA |
...
| `Agent` | 基于模型的工具编排与代理系统 | API Agent、智能体、agentic system、AI agent |
| `MCP` | Model Context Protocol | Model Context Protocol、model context protocol |
| `Embedding` | 文本或多模态向量表征 | embeddings、向量化、向量表示 |
